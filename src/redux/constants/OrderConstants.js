...
export const ORDER_APPROVED_REQUEST = "ORDER_APPROVED_REQUEST";
export const ORDER_APPROVED_SUCCESS = "ORDER_APPROVED_SUCCESS";
export const ORDER_APPROVED_FAIL = "ORDER_APPROVED_FAIL";
export const ORDER_APPROVED_RESET = "ORDER_APPROVED_RESET";
